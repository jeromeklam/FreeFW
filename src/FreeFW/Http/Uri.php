...
class Uri implements UriInterface
{
     ...
     *
     * An instance of UriInterface can either be an absolute URI or a relative reference.
     * This method returns true
     * if it is the former. An absolute URI has a scheme. A relative reference is used
     * to express a URI relative
    ...
    private function validateState()
    {
        ...
        if ($this->getAuthority() === '') {
            ...
            @trigger_error(
                ...
                ' Automagically fixing the URI by adding a leading slash to the path is deprecated' .
                ' since version 1.4 and will throw an exception instead.',
                E_USER_DEPRECATED
            );
            $this->path = '/'. $this->path;
        }
